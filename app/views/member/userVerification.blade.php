...
<div class="col-md-6 col-md-offset-3">
      <div class="panel panel-default">
                    <div class="panel-heading">Username Verification</div>
        ...
        </td></tr>       <tr> <td></td><td><div  style="float:right">{{ Form::submit('Verify',array('id'=>'submit','class'=>'btn btn-primary')) }}</td></tr>
        </div>
        </tbody></table>
      </div></div></div>
  </div>
